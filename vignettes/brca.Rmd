...
shell pipeline (FYI that's a TAB character, not a space, in the 'cut' invocation;
on many computers you can get a tab character by pressing CTRL+V followed by TAB).
...
Let's say that we're interested in just solid tumor samples, coded as 01.
...
The next step of our example computes a thresholded gene correlation matrices
